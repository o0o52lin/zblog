...
<head>
	...
	<link rel="stylesheet" href="{$host}zb_users/theme/{$theme}/style/fancybox.css?{$themeinfo['modified']}" type="text/css" media="all"/>
	<link rel="stylesheet" href="{$host}zb_users/theme/{$theme}/style/swiper-bundle.min.css?{$themeinfo['modified']}" type="text/css" media="all"/>
